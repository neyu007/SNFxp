Public Class NewSalesAgentForm
    ...
    Private Sub SalesAgentBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles SalesAgentBindingNavigatorSaveItem.Click
        Me.Validate()
    ...
    Private Sub NewSalesAgentForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Me.BranchTableAdapter.Fill(Me.SalesAgentDataSet.Branch)
